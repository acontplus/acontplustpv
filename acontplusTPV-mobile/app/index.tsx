...
function PowerSyncStatusBadge() {
  ...
  // FIX: leer solo primitivos booleanos en lugar del objeto completo.
  // usePowerSyncStatus() en algunas versiones del SDK reconstruye el objeto
  // de status en cada tick, causando el warning "The result of getSnapshot
  // should be cached" de React 18 (useSyncExternalStore llama getSnapshot
  // dos veces y espera referential equality).
  // Los primitivos son siempre referencialmente estables — este patrón
  // elimina el warning sin necesidad de memoización adicional.
